...
export INPUT_PATH="${PNFS_SCRATCH}/WCSim_grid/MC_toolchain_dirt_muons/"
export OUTPUT_FOLDER="${PNFS_PERSISTENT}/output/dirt_muons/Trees/"
export WCSIM_FILES_PATH="${PNFS_PERSISTENT}/output/dirt_muons/"
